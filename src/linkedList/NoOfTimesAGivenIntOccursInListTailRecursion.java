...
public class NoOfTimesAGivenIntOccursInListTailRecursion
{
 ...
 int count(Node head,int search_for)
 {
	 ...
	 int freq=count(head.next, search_for);
 ...
 {
     NoOfTimesAGivenIntOccursInListTailRecursion llist = new NoOfTimesAGivenIntOccursInListTailRecursion();
